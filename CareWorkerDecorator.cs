...
namespace BusinessLayer
{
    ...
    // Class Name: CareWorkerDecorator.cs

    // Purpose of Class: To store data about different types of Care Workers in the system.
    // Last Modified Date: 16/11/2019 @ 13:00
    // Date of Completion: 16/11/2019 @ 13:00
    public class CareWorkerDecorator : Staff
    {
        ...
        public CareWorkerDecorator(int staffID, string firstName, string surname, string address1, string address2, string category, double locLat, double locLon)
        {
